...
return op
  ...
  var peg$f42 = function() {return crearNodo('primitivo', { valor: parseFloat(text(), 10), tipo:'int' }) };
  var peg$f43 = function(texto) { return crearNodo('primitivo', { valor: texto.join(''), tipo:'string' }) };
  var peg$f44 = function() { return crearNodo('primitivo', { valor: true, tipo:'boolean' }) };
  var peg$f45 = function() { return crearNodo('primitivo', { valor: false, tipo:'boolean' }) };
  var peg$f46 = function(exp) { return crearNodo('agrupacion', { exp }) };
  var peg$f47 = function(id, args) { return crearNodo('instancia', { id, args: args || [] }) };
  var peg$f48 = function(id) { return crearNodo('referenciaVariable', { id }) };
