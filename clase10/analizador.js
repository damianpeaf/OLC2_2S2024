...
function peg$parse(input, options) {
  ...
  var peg$e29 = peg$literalExpectation("new", false);
...
return op
  ...
  var peg$f40 = function() {return crearNodo('primitivo', { valor: parseFloat(text(), 10), tipo:'int' }) };
  var peg$f41 = function(texto) { return crearNodo('primitivo', { valor: texto.join(''), tipo:'string' }) };
  var peg$f42 = function(exp) { return crearNodo('agrupacion', { exp }) };
  var peg$f43 = function(id, args) { return crearNodo('instancia', { id, args: args || [] }) };
  var peg$f44 = function(id) { return crearNodo('referenciaVariable', { id }) };
