...
function peg$parse(input, options) {
  ...
  var peg$f4 = function(num) { return { tipo: "-", der: num } };
  var peg$f5 = function() { return{ tipo: "numero", valor: parseFloat(text(), 10) } };
  var peg$f6 = function(exp) { return { tipo: "parentesis", exp } };
