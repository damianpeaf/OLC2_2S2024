...
function peg$parse(input, options) {
  ...
  var peg$e33 = peg$literalExpectation("new", false);
  ...
  var peg$f36 = function(num) { return crearNodo('unaria', { op: '-', exp: num }) };
  var peg$f37 = function(objetivoInicial, args) { return {args, tipo: 'funcCall' } };
  var peg$f38 = function(objetivoInicial, id) { return { id, tipo: 'get' } };
  var peg$f39 = function(objetivoInicial, operaciones) {
...
return op
  ...
  var peg$f40 = function(arg, exp) { return exp };
  var peg$f41 = function(arg, args) { return [arg, ...args] };
  var peg$f42 = function() {return crearNodo('primitivo', { valor: parseFloat(text(), 10), tipo:'float' }) };
  var peg$f43 = function() {return crearNodo('primitivo', { valor: parseFloat(text(), 10), tipo:'int' }) };
  var peg$f44 = function(texto) { return crearNodo('primitivo', { valor: texto.join(''), tipo:'string' }) };
  var peg$f45 = function() { return crearNodo('primitivo', { valor: true, tipo:'boolean' }) };
  var peg$f46 = function() { return crearNodo('primitivo', { valor: false, tipo:'boolean' }) };
  var peg$f47 = function(exp) { return crearNodo('agrupacion', { exp }) };
  var peg$f48 = function(id, args) { return crearNodo('instancia', { id, args: args || [] }) };
