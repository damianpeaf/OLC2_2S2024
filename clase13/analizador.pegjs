...
FuncDcl = "function" _ id:Identificador _ "(" _ params:Parametros? _ ")" _ tipo:(":" _ tipo:Identificador { return tipo })? _ bloque:Bloque { return crearNodo('dclFunc', { id, params: params || [], bloque, tipo }) }
...
Param = id:Identificador _ ":" _ tipo:Identificador { return crearNodo('param', { id, tipo }) }
