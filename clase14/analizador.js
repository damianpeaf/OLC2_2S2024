...
function peg$parse(input, options) {
  ...
  var peg$f6 = function(id, params, tipo) { return tipo };
  var peg$f7 = function(id, params, tipo, bloque) { return crearNodo('dclFunc', { id, params: params || [], bloque, tipo }) };
  var peg$f8 = function(id, dcls) { return crearNodo('dclClase', { id, dcls }) };
  var peg$f9 = function(dcl) { return dcl };
  var peg$f10 = function(dcl) { return dcl };
  var peg$f11 = function(id, ids) { return ids };
  var peg$f12 = function(id, params) { return [id, ...params] };
  var peg$f13 = function(id, tipo) { return crearNodo('param', { id, tipo }) };
  var peg$f14 = function(exp) { return crearNodo('print', { exp }) };
  var peg$f15 = function(Bloque) { return Bloque };
  ...
  var peg$f19 = function(init, cond, inc, stmt) {
      return crearNodo('for', { init, cond, inc, stmt })
    };
  var peg$f20 = function() { return crearNodo('break') };
  var peg$f21 = function() { return crearNodo('continue') };
  var peg$f22 = function(exp) { return crearNodo('return', { exp }) };
  var peg$f23 = function(exp) { return crearNodo('expresionStmt', { exp }) };
  ...
  var peg$f29 = function(asignado, asgn) { 
  ...
  var peg$f38 = function(num) { return crearNodo('unaria', { op: '-', exp: num }) };
  var peg$f39 = function(objetivoInicial, args) { return {args, tipo: 'funcCall' } };
  var peg$f40 = function(objetivoInicial, id) { return { id, tipo: 'get' } };
  var peg$f41 = function(objetivoInicial, operaciones) {
...
return op
  ...
  var peg$f42 = function(arg, exp) { return exp };
  var peg$f43 = function(arg, args) { return [arg, ...args] };
  var peg$f44 = function() {return crearNodo('primitivo', { valor: parseFloat(text(), 10), tipo:'float' }) };
  var peg$f45 = function() {return crearNodo('primitivo', { valor: parseFloat(text(), 10), tipo:'int' }) };
  var peg$f46 = function(texto) { return crearNodo('primitivo', { valor: texto.join(''), tipo:'string' }) };
  var peg$f47 = function() { return crearNodo('primitivo', { valor: true, tipo:'boolean' }) };
  var peg$f48 = function() { return crearNodo('primitivo', { valor: false, tipo:'boolean' }) };
  var peg$f49 = function(exp) { return crearNodo('agrupacion', { exp }) };
  var peg$f50 = function(id, args) { return crearNodo('instancia', { id, args: args || [] }) };
  var peg$f51 = function(id) { return crearNodo('referenciaVariable', { id }) };
      ...
      if (s3 !== peg$FAILED) {
        ...
        if (s5 !== peg$FAILED) {
          ...
          if (s9 !== peg$FAILED) {
            ...
            if (s12 !== peg$FAILED) {
              s13 = peg$parse_();
              s14 = peg$parseIdentificador();
              if (s14 !== peg$FAILED) {
                peg$savedPos = s11;
                s11 = peg$f6(s3, s7, s14);
              } else {
                peg$currPos = s11;
                s11 = peg$FAILED;
              }
